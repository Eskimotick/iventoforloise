...
class ConfirmOldEmailNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
      ...
      ->line('Por favor confirme que está trocando seu e-mail antigo clicando no botão abaixo.')
      ->action('Confirmar e-mail', env('App_Url').'/confirm/'.$notifiable->old_email_code)
      ->line('Caso não tenha solicitado a alteação desconsidere esta mensagem.')
      ->line('Seu e-mail só será alterado assim que a confirmação for realizada tanto neste quanto no e-mail novo.')
